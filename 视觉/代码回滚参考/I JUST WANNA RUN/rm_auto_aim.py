        ...
        for count in range(0, n):
            ...
            while findCache < n:  # 未超界，进行匹配运算
                ...
                if area1 != 0 and area2 != 0:
                    ...
                    # if (1 <= calc_area < 10) and (2.3 < calcCache < 3) and (x[findCache] - x[count]) ** 2 > (
                    #         y[findCache] - y[count]) ** 2:  # 小装甲板
                    if (1 <= calc_area < 10) and (4 < calcCache < 5) and (x[findCache] - x[count]) ** 2 > (
        ...
        if pairNum != 0:
            ...
            for count in range(0, pairNum):
                ...
                if K < 0.4:
                    ...
                    tf_img = big_WarpPerspect(WarpPerspect_img, ts_box)
